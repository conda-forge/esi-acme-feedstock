...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/esi-acme-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13024&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/esi-acme-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `esi-acme` can be installed with:

```
conda install esi-acme
```

It is possible to list all of the versions of `esi-acme` available on your platform with:
